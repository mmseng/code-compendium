...
-->
 ...
 | [get-ou-of-existing-ad-object-and-delete](https://github.com/engrit-illinois/get-ou-of-existing-ad-object-and-delete) | Script for MECM Task Sequence to retrieve the computer's AD object OU and delete the object before the TS recreates the object and joins the computer. | automation | Powershell | University | 

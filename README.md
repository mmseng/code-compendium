...
-->
 ...
 | [Get-PsVersion](https://github.com/engrit-illinois/Get-PsVersion) | A hacky PowerShell function to get the PowerShell version of a remote machine. | data gathering and reporting | Powershell | Public | 

...
-->
 ...
 | [Get-Model](https://github.com/engrit-illinois/Get-Model) | Gets model and other info (WMI Win32_ComputerSystem class) from remote endpoints | data gathering/reporting | Powershell | Public | 

...
-->
 ...
 | [Get-GpoContainingSetting](https://github.com/engrit-illinois/Get-GpoContainingSetting) | Searches GPOs in the given domain and returns those which have names matching a given string, and which contain XML matching a given string. | data gathering/reporting, auditing | Powershell | Public | 
 ...
 | [Cctk-Computer](https://github.com/engrit-illinois/Cctk-Computer) | Module for running CCTK commands on one or more remote Dell computers | scripting of repetitive processes | Powershell | Private | 

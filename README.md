...
-->
 ...
 | [ScriptName](https://github.com/engrit-illinois/Get-CMAppFromContentId) | Tries to find the name of the MECM application package associated with a given Content ID. | info gathering/reporting | Powershell | University | 
